...
import {
  ...
  ClipboardList, ShoppingCart, FileText, Factory, ShoppingBag, Boxes, ScrollText, Bell,
...
export const navGroupsEmpresa = [
  ...
  { label: 'Operações', items: [
    { href: '/requisicoes-compra', label: 'Requisições de Compra', icon: ClipboardList, perm: 'requisicoes_compra' },
    { href: '/pedidos-compra', label: 'Pedidos de Compra', icon: ShoppingCart, perm: 'pedidos_compra' },
